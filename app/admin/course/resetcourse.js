...
export default function Home({ schedule_id, setInfo, getData }) {
  ...
  async function submit() {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL_8102}/fjbc_tutoring_api/tutoring/course_schedule/modification/${schedule_id}/co`, config);
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className="text-center text-2xl text-blue-400">恢復上課</div>
              <div className="mt-2">
