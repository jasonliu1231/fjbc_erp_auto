...
export default function Home() {
  ...
  async function getData() {
    ...
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL_8102}/fjbc_tutoring_api/wage/statements/page8?year=${year}&month=${month}&tutoring_id=${tutoring}`, config);
